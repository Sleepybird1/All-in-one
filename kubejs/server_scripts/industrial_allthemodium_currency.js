...
const atmDeploying = (tier, transitional, ingredient) => ({
  type: `industrial_colonies:${tier}_deploying`,
  ingredients: [{ item: transitional }, { item: ingredient }],
  results: [{ id: transitional }]
})

const atmPressing = (tier, transitional) => ({
  type: `industrial_colonies:${tier}_pressing`,
...
ServerEvents.recipes(event => {
  ...
  sequencedElement(
    ...
    4,
    [
      atmDeploying('weathered_iron', 'tfmg:steel_ingot', 'modernfoundry:cobalt_ingot'),
      atmDeploying('weathered_iron', 'tfmg:steel_ingot', 'mekanism:ingot_osmium'),
      atmDeploying('weathered_iron', 'tfmg:steel_ingot', 'tfmg:steel_mechanism'),
      atmPressing('weathered_iron', 'tfmg:steel_ingot')
    ]
  )
  ...
  sequencedElement(
    ...
    4,
    [
      atmDeploying('weathered_iron', 'allthemodium:allthemodium_ingot', 'industrial_colonies:yellorium_compound'),
      atmDeploying('weathered_iron', 'allthemodium:allthemodium_ingot', 'modernfoundry:cobalt_ingot'),
      atmDeploying('weathered_iron', 'allthemodium:allthemodium_ingot', 'tfmg:steel_mechanism'),
      atmPressing('weathered_iron', 'allthemodium:allthemodium_ingot')
    ]
  )
  ...
  sequencedElement(
    ...
    4,
    [
      atmDeploying('refined_radiance', 'allthemodium:vibranium_ingot', 'create:refined_radiance'),
      atmDeploying('refined_radiance', 'allthemodium:vibranium_ingot', 'industrial_colonies:yellorium_compound'),
      atmDeploying('refined_radiance', 'allthemodium:vibranium_ingot', 'mekanism:ultimate_control_circuit'),
      atmPressing('refined_radiance', 'allthemodium:vibranium_ingot')
    ]
  )
